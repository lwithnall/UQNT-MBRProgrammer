    ...
    return (
        <div className="h-full w-full p-5 text-lg">
            ...
            <div className="absolute m-5 bottom-0 right-0">
                <Button className="bg-black h-12 w-12" icon={IoIosArrowBack} onClick={decIdx} size="icon" disabled={pageIdx === 0} />
                <Button className="bg-black h-12 w-12" icon={IoIosArrowForward} onClick={incIdx} size="icon" disabled={pageIdx === pages.length - 1} />
            </div>
        </div>
    )
}   