...
python.pythonGenerator.forBlock['ast_AnnAssignFull'] = function (block, generator) {
  ...
  let target =
    python.pythonGenerator.valueToCode(block, 'TARGET', python.pythonGenerator.ORDER_NONE) ||
    python.pythonGenerator.blank;
  let annotation =
    python.pythonGenerator.valueToCode(block, 'ANNOTATION', python.pythonGenerator.ORDER_NONE) ||
    python.pythonGenerator.blank;
  let value = '';
  if (this.initialized_) {
    value =
      ' = ' +
        python.pythonGenerator.valueToCode(block, 'VALUE', python.pythonGenerator.ORDER_NONE) ||
      python.pythonGenerator.blank;
  }
...
python.pythonGenerator.forBlock['ast_AnnAssign'] = function (block, generator) {
  // Create a list with any number of elements of any type.
  var target = python.pythonGenerator.getVariableName(
...
BlockMirrorTextToBlocks.prototype['ast_AnnAssign'] = function (node, parent) {
  ...
  if (
    ...
    target.id.v !== python.pythonGenerator.blank &&
